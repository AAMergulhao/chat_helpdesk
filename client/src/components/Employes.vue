<template>
  <div>
    ...
    <div id="modal_usuario" class="modal" style="height: 400px">
        ...
        <div class="col s12 m8 offset-m2 l6 offset-l3">
          <div class="card-panel grey lighten-5 z-depth-1">
            <div class="row valign-wrapper">
              ...
              <div class="col s6">
                <a class="btn-small blue" style="margin-bottom: 5px"
                  >Enviar Mensagem</a
                >
                <br />
                <a href="#modal_atividade" class="btn-small modal-trigger orange"
                  >Agendar Atividade</a
                >
              </div>
            </div>
    ...
    <div id="modal_atividade" class="modal" style="height: 400px">
      <div class="modal-content">
        ...
        <div class="row">
          ...
          <a class="btn green" v-on:click="postAtividade()"
            >Agendar Atividade</a
          >
        </div>
      </div>
